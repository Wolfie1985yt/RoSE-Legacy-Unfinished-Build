...
class PauseSubState extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float)
	{
		...
		topBar = new FlxSprite(-290, 380).loadGraphic(Paths.image('pauseStuff/topbar'));
		...
		box = new FlxSprite(-290, 140).loadGraphic(Paths.image('pauseStuff/frame'));
		...
		if (OpenFlAssets.exists(Paths.txt(PlayState.SONG.song.toLowerCase() + "/lore")))
			lore = OpenFlAssets.getText(Paths.txt(PlayState.SONG.song.toLowerCase() + "/lore"));
		else
			lore = OpenFlAssets.getText(Paths.txt("no-pausemenu"));
		
		textStuff = new FlxText(138, 338, 430, lore);
		textStuff.setFormat(Paths.font('advanced.ttf'), 19, 0xFFFFFFFF);
		textStuff.antialiasing = true;
		textStuff.alpha = 0;
		add(textStuff);
		
		loreTxt = new FlxText(232, 279, 920, "Story");
		loreTxt.setFormat(Paths.font('advanced.ttf'), 17, 0xFFFFFFFF);
		loreTxt.antialiasing = true;
		loreTxt.alpha = 0;
		add(loreTxt);
		
		devTxt = new FlxText(410, 279, 920, "Dev Message");
		devTxt.setFormat(Paths.font('advanced.ttf'), 17, 0xFF1c1c1c);
		devTxt.antialiasing = true;
		devTxt.alpha = 0;
		add(devTxt);
	...
	function TweenIn():Void
	{
		...
		FlxTween.tween(box, {alpha: 1}, 0.25, { ease: FlxEase.expoInOut });
		FlxTween.tween(textStuff, {alpha: 1}, 0.25, { ease: FlxEase.expoInOut });
		FlxTween.tween(devTxt, {alpha: 1}, 0.25, { ease: FlxEase.expoInOut });
		FlxTween.tween(loreTxt, {alpha: 1}, 0.25, { ease: FlxEase.expoInOut });
		FlxTween.tween(topBar, {alpha: 1}, 0.25, { ease: FlxEase.expoInOut });
		FlxTween.tween(timeBarBG, {alpha: 1}, 0.70, { ease: FlxEase.expoInOut });
		FlxTween.tween(timeBar, {alpha: 1}, 0.70, { ease: FlxEase.expoInOut });	
		FlxTween.tween(PauseIconP1, {alpha: 1}, 0.70, { ease: FlxEase.expoInOut });
		FlxTween.tween(bg, {alpha: 0.7}, 0.50, { ease: FlxEase.expoInOut });
		FlxTween.tween(timeBarBG, {x: 130}, 0.70, { ease: FlxEase.expoInOut });
		FlxTween.tween(timeBar, {x: 130}, 0.70, { ease: FlxEase.expoInOut });
		FlxTween.tween(PauseIconP1, {x: 60}, 0.70, { ease: FlxEase.expoInOut });
	}

	function TweenInSmallWindow():Void
	{
		FlxTween.tween(top, {x: 100}, 0.25, { ease: FlxEase.expoInOut });
		FlxTween.tween(panel, {x: -160}, 0.25, { ease: FlxEase.expoInOut });
		switch (ClientPrefs.Language) {
			case 'Russian', 'Spanish':
				FlxTween.tween(exit3, {x: 514}, 0.25, { ease: FlxEase.expoInOut });
				FlxTween.tween(exit2, {x: 514}, 0.25, { ease: FlxEase.expoInOut });
				FlxTween.tween(exit1, {x: 539}, 0.25, { ease: FlxEase.expoInOut });
				FlxTween.tween(restart3, {x: 599}, 0.25, { ease: FlxEase.expoInOut });
				FlxTween.tween(restart2, {x: 599}, 0.25, { ease: FlxEase.expoInOut });
				FlxTween.tween(restart1, {x: 624}, 0.25, { ease: FlxEase.expoInOut });
				FlxTween.tween(continue3, {x: 679}, 0.25, { ease: FlxEase.expoInOut });
				FlxTween.tween(continue2, {x: 679}, 0.25, { ease: FlxEase.expoInOut });
				FlxTween.tween(continue1, {x: 704}, 0.25, { ease: FlxEase.expoInOut });
			default:
				FlxTween.tween(exit3, {x: 545}, 0.25, { ease: FlxEase.expoInOut });
				FlxTween.tween(exit2, {x: 545}, 0.25, { ease: FlxEase.expoInOut });
				FlxTween.tween(exit1, {x: 570}, 0.25, { ease: FlxEase.expoInOut });
				FlxTween.tween(restart3, {x: 630}, 0.25, { ease: FlxEase.expoInOut });
				FlxTween.tween(restart2, {x: 630}, 0.25, { ease: FlxEase.expoInOut });
				FlxTween.tween(restart1, {x: 655}, 0.25, { ease: FlxEase.expoInOut });
				FlxTween.tween(continue3, {x: 710}, 0.25, { ease: FlxEase.expoInOut });
				FlxTween.tween(continue2, {x: 710}, 0.25, { ease: FlxEase.expoInOut });
				FlxTween.tween(continue1, {x: 735}, 0.25, { ease: FlxEase.expoInOut });
		}
		FlxTween.tween(box, {alpha: 1}, 0.25, { ease: FlxEase.expoInOut });
		FlxTween.tween(textStuff, {alpha: 1}, 0.25, { ease: FlxEase.expoInOut });
		FlxTween.tween(devTxt, {alpha: 1}, 0.25, { ease: FlxEase.expoInOut });
		...
		FlxTween.tween(PauseIconP1, {alpha: 1}, 0.70, { ease: FlxEase.expoInOut });
		FlxTween.tween(bg, {alpha: 0.7}, 0.50, { ease: FlxEase.expoInOut });
		FlxTween.tween(timeBarBG, {x: 230}, 0.70, { ease: FlxEase.expoInOut });
		FlxTween.tween(timeBar, {x: 230}, 0.70, { ease: FlxEase.expoInOut });
		FlxTween.tween(PauseIconP1, {x: 160}, 0.70, { ease: FlxEase.expoInOut });
	}
	...
	override function update(elapsed:Float)
	{
		...
		if (controls.UI_RIGHT_P)
		{
			...
			if (OpenFlAssets.exists(Paths.txt(PlayState.SONG.song.toLowerCase() + "/devMessage")))
				lore = OpenFlAssets.getText(Paths.txt(PlayState.SONG.song.toLowerCase() + "/devMessage"));
			else
				lore = OpenFlAssets.getText(Paths.txt("no-pausemenu"));
			...
			loreTxt = new FlxText(232, 279, 920, "Story");
			loreTxt.setFormat(Paths.font('advanced.ttf'), 17, 0xFF1c1c1c);
			loreTxt.antialiasing = true;
			loreTxt.alpha = 1;
			add(loreTxt);
		
			devTxt = new FlxText(410, 279, 920, "Dev Message");
			devTxt.setFormat(Paths.font('advanced.ttf'), 17, 0xFFFFFFFF);
			devTxt.antialiasing = true;
			devTxt.alpha = 1;
			add(devTxt);
		}
