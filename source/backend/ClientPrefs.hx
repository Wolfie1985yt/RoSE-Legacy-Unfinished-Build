...
class ClientPrefs {
	...
	public static var windowReset:Bool = false;
	...
	public static var comboOffset:Array<Int> = [-354, -318, -258, -80];
	...
	public static var fatalSide:Bool = false;
	public static var SpeedwayUnlocked:Bool = false;
	...
	public static var UnlockedMenuArts:Array<String> = ['xeno-1', 'bf-gf']; 
	...
	public static var preloadAssets:Bool = true;
	public static var firstLaunchMenusWas:Array<String> = [''];
	public static var youSawSoundTestCutscene:Bool = false;
	public static var SoundTestCodesUnlocked:Array<String> = [];
	
	public static var cutsceneYouSaw:Array<String> = []; 
	public static var showCutscene:Array<String> = []; 
	public static var songsHaveCutsceneCheckbox:Array<String> = []; 
	...
	public static function saveSettings() {
		...
		FlxG.save.data.windowReset = windowReset;
		...
		FlxG.save.data.fatalSide = fatalSide;
		FlxG.save.data.SpeedwayUnlocked = SpeedwayUnlocked;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.windowReset != null) {
			windowReset = FlxG.save.data.windowReset;
		}
		...
		if(FlxG.save.data.fatalSide != null) {
			fatalSide = FlxG.save.data.fatalSide;
		}
		if(FlxG.save.data.SpeedwayUnlocked != null) {
			SpeedwayUnlocked = FlxG.save.data.SpeedwayUnlocked;
		}
		...
		if(FlxG.save.data.preloadAssets != null) {
			preloadAssets = FlxG.save.data.preloadAssets;
		}
		...
		if(FlxG.save.data.SoundTestCodesUnlocked != null) {
			SoundTestCodesUnlocked = FlxG.save.data.SoundTestCodesUnlocked;
		}
	...
	public static function reloadControls() {
		backend.PlayerSettings.player1.controls.setKeyboardScheme(KeyboardScheme.Solo);

		vlc.Cutscenes.muteKeys = copyKey(keyBinds.get('volume_mute'));
		vlc.Cutscenes.volumeDownKeys = copyKey(keyBinds.get('volume_down'));
		vlc.Cutscenes.volumeUpKeys = copyKey(keyBinds.get('volume_up'));
