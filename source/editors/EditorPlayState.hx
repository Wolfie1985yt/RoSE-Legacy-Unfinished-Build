...
class EditorPlayState extends MusicBeatState
{
	...
	private function generateStaticArrows(player:Int):Void
	{
		for (i in 0...4)
		{
			...
			var babyArrow:StrumNote = new StrumNote(ClientPrefs.middleScroll ? PlayState.STRUM_X_MIDDLESCROLL : PlayState.STRUM_X, strumLine.y, i, player, 'normal');
	...
	function spawnNoteSplash(x:Float, y:Float, data:Int, ?note:Note = null) {
		...
		if (PlayState.instance.noteChangesFromTheStore)
			skin = 'arrows/'+ClientPrefs.arrowSplash;
		else
			skin = 'arrows/noteSplashes';
