...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['startstatic', "comedy"],
		['tailsjump', "i have been coding triple trouble for 7 FUCKING HOURS\nthis is a new form of torture is swear"],
		['knuxjump', "im doing the jumpscares then going to bed FUCK YOU its 3am and ive been doing thin since 4am"],
		['eggjump', "eggballs ahghhgahhaAGHAGHAHGAGHAHWANGHGASDGHJWERSAGSHEJDJGHAGFGHSDSHFGAGHDSFGAHFDSGHDSFHGSFDGHSFDGHSFGHDDFNDFGDG"],
		['tdjump', "uhahahahah"],
		['nmijump', "boooo"],
		['melthogjump', "bruh"],
		['amyjump', "vine boom"],
		['wechidnajump', "kys betch"],
		...
		['Song Speed Change', "Bruh"],
		['Cool Bars', "Value 1: 1 - ON, 0 - OFF"],
