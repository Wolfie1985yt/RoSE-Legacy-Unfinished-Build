...
#end
import objects.FlxUIDropDownMenuCustom as FlxUIDropDownMenuCustom;

using StringTools;

class BuggyChartingState extends MusicBeatState
{
	...
	[
		...
		['Add Camera Zoom', "You really love those beloved zooms so much aren't you?\nValue 1: Camera zoom add (Default: 0.015)\nValue 2: UI zoom add (Default: 0.03)\nLeave the values blank if you want to use Default."],
		['Alt Idle Animation', "Sets a specified suffix after the idle animation name.\nYou can use this to trigger 'idle-alt' if you set\nValue 2 to -alt\n\nValue 1: Character to set (Dad, BF or GF)\nValue 2: New suffix (Leave it blank to disable)"],
		['amyjump', "Amy Scares you, altough she doesn't have a mouth to \nscream, not even to eat ice cream... poor girl :("],
		...
		['Camera Follow Pos', "Value 1: X\nValue 2: Y\n\nThe camera won't change the follow point after using \nthis, for getting it back to normal, leave both values \nblank."],
		['Change Character', "Value 1: Character to change (Dad, BF, GF)\nValue 2: New character's name"],
		['Change Scroll Speed', "Value 1: Scroll Speed Multiplier (1 is default)\nValue 2: Time it takes to change fully in seconds."],
		['Change Windows Wallpaper', "Value 1: Image of wallpaper (in assets/exe/images)\nExample: BG"],
		['char appear', "The Playable Character makes an apparition! Scary"],
		['char disappear', "The Playable Character is gone! Spoopy"],
		['Character Fly', "The Character is flying! Stop using Noclip!"],
		['Chroma Video', "You are a YT editor now!\nValue 1: MP4 name\nThese won't show with flashing lights off because\nthis is mostly used for MLG shit!!"],
		['Clear Popups', "Removes all Fatal Error popups, finally that \nAdBlocker works."],
		['Cool Bars', "Cinematic Bars for your moment filled with drama!\nValue 1: 1 - ON, 0 - OFF"],
		['eggjump', "Eggman Scares You, he is proud of that one, you can\nsee his brain trembling with happiness"],
		['Fatality Popup', "Fatal Error spams his virus, STOP FUCKING MY RAM!\nValue 1: Amount of popups\nValue 2: Type (1, 2 or 3)\nType 2 ignores the hard cap of 10 popups\nand are also a bit bigger\nType 3 is the same but alot bigger"],
		['funnystatic', "Do you like the Static? Clearly you don't"],
		['Genesis', "It changes your Strum for a pixel experience!"],
		['Hey!', "Plays the \"Hey!\" animation from Bopeebo,\nValue 1: BF = Only Boyfriend, GF = Only Girlfriend,\nSomething else = Both.\nValue 2: Custom animation duration,\nleave it blank for 0.6s"],
		['Kill Henchmen', "For Mom's songs... \nStop the Henchmen abuse :("],
		['knuxjump', "Knuckles Scares You, he really doesn't need your power"],
		['Lyrics', "The memes who comes from this kind of videos dies \nin the lifespan of 2 weeks\nValue 1: Text and optionally, colour\n(To specify colour, seperate it by a --)\nValue 2: Duration, in seconds.\nDuration defaults to text length multiplied by 0.5"],
		['Majin count', "Majin is counting into the infinite"],
		['Majin spin', "Majin notes spins into infinity!"],
		['melthogjump', "Melthog Scares You, but his voice is so melted that\nyou can only hear gibberish"],
		['nmijump', "NMI Scares You, No Analog Horror in this place"],
		['Play Animation', "Plays an animation on a Character, once the animation \nis completed, the animation changes to the Idle\n\nValue 1: Animation to play.\nValue 2: Character (Dad, BF, GF)"],
		['Play Video', "Plays a video during the song, must be 1280x720p\n\nValue 1: Video name\nValue 2: Video length"],
		['Pnotefade', "The Notes and Sturm Dissapears"],
		['Pnotein', "The Notes and Sturm Appears"],
		['RedVG', "A cool effect for dramatic scenes"],
		['Screen Shake', "Value 1: Camera shake\nValue 2: HUD shake\n\nEvery value works as the following example: \"1, 0.05\".\nThe first number (1) is the duration.\nThe second number (0.05) is the intensity."],
		['Set GF Speed', "Sets GF head bopping speed,\nValue 1: 1 = Normal speed,\n2 = 1/2 speed, 4 = 1/4 speed etc.\nUsed on Fresh during the beatbox parts.\n\nWarning: Value must be integer!"],
		['Song Speed Change', "The song is getting faster! Gotta Go Fast!"],
		['sonicspook', "Xeno Scares You, his mod, his rules!"],
		['spingbing', "The opponent becomes a Haxe Logo, creepiest shit \nI ever seen"],
		['startstatic', "Cmon TV, Work dammit!"],
		['static', "My TV Signal is so bad today"],
		['strum swap1', "It changes the Strum to other one"],
		['strum swap2', "It changes the Strum to other one... again"],
		['tailsjump', "Tails Scares You, altough he doesn't know where are \nyou, so he just screamed at a wall"],
		['tdjump', "Tails Doll Scares You, this is the best marketable plushie"],
		['TDnoteshitdie', "This is kinda buggy"],
		['TDnoteshitlive', "This is kinda buggy"],
		['TooSlowFlashinShit', "My fucking eyes Xeno, you betch!\nValue 1:"],
		['Trigger BG Ghouls', "Should be used only in \"schoolEvil\" Stage!"],
		['wechidnajump', "Wechidna Scares You, get away of his horizon"]
	];
	...
	public static var bfIdle:Bool = true;
	public static var bfLeft:Bool = false;
	public static var bfRight:Bool = false;
	public static var bfUp:Bool = false;
	public static var bfDown:Bool = false;

	public static var dadIdle:Bool = true;
	public static var dadLeft:Bool = false;
	public static var dadRight:Bool = false;
	public static var dadUp:Bool = false;
	public static var dadDown:Bool = false;
	...
	**/
	...
	override function create()
	{
		...
		else
		{
			_song = {
				...
				isRing: false,
				arrowSkin: null,
				splashSkin: null,//idk it would crash if i didn't
				player1: 'bf',
				player2: 'dad',
				player3: null,
				gfVersion: 'gf',
		...
		#if linux
		DiscordClient.imageRpc = 'chart-editor';
		switch (PlayState.SONG.song.toLowerCase())
		{
			default: DiscordClient.smallImageRpc = '';
			//Story Mode
			case 'too-slow': DiscordClient.smallImageRpc = 'too-slow';
			case 'you-cant-run': DiscordClient.smallImageRpc = 'you-cant-run';
			case 'triple-trouble': DiscordClient.smallImageRpc = 'triple-trouble';
			case 'final-escape': DiscordClient.smallImageRpc = 'final-escape';
			case 'face-off': DiscordClient.smallImageRpc = 'face-off';
			case 'coulrophobia': DiscordClient.smallImageRpc = 'coulrophobia';
			case 'broken-heart': DiscordClient.smallImageRpc = 'broken-heart';
			case 'tribal': DiscordClient.smallImageRpc = 'tribal';
			case 'goddess': DiscordClient.smallImageRpc = 'goddess';
			...
			case 'execution': DiscordClient.smallImageRpc = 'execution';
			case 'cycles': DiscordClient.smallImageRpc = 'lord-x';
			...
			case 'my-horizon': DiscordClient.smallImageRpc = 'chaotix';
			case 'our-horizon': DiscordClient.smallImageRpc = 'horizon';
			...
			case 'envy': DiscordClient.smallImageRpc = 'grimeware';
			...
			case 'universal-collapse': DiscordClient.smallImageRpc = 'omw';
			case 'planestrider': DiscordClient.smallImageRpc = 'omw-2';
			case 'too-far' | 'too-far-alt' | 'last-hope': DiscordClient.smallImageRpc = 'gameover';
					
			//Encore
			case 'too-slow-encore' | 'too-slow-encore-alt': DiscordClient.smallImageRpc = 'too_slow_encore';
			case 'you-cant-run-encore': DiscordClient.smallImageRpc = 'you_cant_run_encore';
			case 'triple-trouble-encore': DiscordClient.smallImageRpc = 'triple_trouble_encore';
			case 'cycles-encore': DiscordClient.smallImageRpc = 'cycles_encore';
			case 'endless-encore': DiscordClient.smallImageRpc = 'endless_encore';
			case 'sunshine-encore': DiscordClient.smallImageRpc = 'sunshine_encore';
			case 'faker-encore': DiscordClient.smallImageRpc = 'faker_encore';
			case 'chaos-encore': DiscordClient.smallImageRpc = 'chaos_encore';
			case 'fatality-encore': DiscordClient.smallImageRpc = 'fatality_encore';
			case 'round-a-bout-encore': DiscordClient.smallImageRpc = 'round_a_bout_encore';
			case 'her-world-encore': DiscordClient.smallImageRpc = 'her_world_encore';
			case 'hollow-encore': DiscordClient.smallImageRpc = 'hollow_encore';
			case 'color-blind-encore': DiscordClient.smallImageRpc = 'color_blind_encore';
			
			//Extras
			case 'hill-of-the-void' | 'ice-cap' | 'execution-inski' | 'gotta-go-red-glove' | 'cool-party' | 'melting-old' | 'drippyshine' | 'terror' | 'haze-og' | 'call-of-justice-old' | 'her-world-old' | 'lukas-world' | 'hollow-old' | 'too-fest-old' | 'tetrabrachial' | 'long-sky' | 'perdition-apollyon' | 'my-horizon-wechidna' | 'playful' | 'color-blind-old': DiscordClient.smallImageRpc = 'extras-songs';
			
			//Secret
			case 'flashcard': DiscordClient.smallImageRpc = 'soink_fla';
		}
		...
		if (TranslationLanguages.Text.exists(rpcF) && ClientPrefs.Language != 'English')
			...
			rpcF = 'Chart Editor';
		var rpcS:String = 'Song: ';
		if (TranslationLanguages.Text.exists(rpcS) && ClientPrefs.Language != 'English')
			rpcS = TranslationLanguages.Text[rpcS];
		DiscordClient.changePresence(rpcF, rpcS + StringTools.replace(_song.song, '-', ' '));
		#end
		if (PlayState.SONG.song.toLowerCase() == 'fatality' || PlayState.SONG.song.toLowerCase() == 'fatality-encore' || PlayState.SONG.song.toLowerCase() == 'critical-error') {
		...
		var bg:FlxSprite = new FlxSprite().loadGraphic(Paths.image('ChartBG'));
		bg.scrollFactor.set();
		add(bg);
		...
		if (isRing) leftIcon.x += 15;
		if (isRing) rightIcon.x += 60;
		...
		if (isRing)
			strumLine = new FlxSprite(0, 50).makeGraphic(Std.int(GRID_SIZE * 11), 5);
		else
		...
		if (isRing) {
			for (i in 0...10){
				var note:StrumNote = new StrumNote(GRID_SIZE * (i+1), strumLine.y, i % 5, 0, 'normal');
		...
		zoomTxt = new FlxText(10, 35, 0, "Zoom: 1x", 16);
		zoomTxt.scrollFactor.set();
		add(zoomTxt);
		
		CodeText = new FlxText(10, 55, 0, "Mechanics Coded By: Merphi & Shyllis", 16);
		CodeText.scrollFactor.set();
		add(CodeText);

		// Characters
		var miniStage:FlxSprite;
		miniStage = new FlxSprite(15, 460);
		miniStage.loadGraphic(Paths.image('bgs/charteditor/lilStage'));
		miniStage.antialiasing = false;
		miniStage.scrollFactor.set();
		add(miniStage);

		gf = new Character(55, 300, 'bfstick', true);
		gf.x += gf.positionArray[0];
		gf.y += gf.positionArray[1];
		dad = new Character(85, 300, 'sticksonic', false);
	...
	function addSongUI():Void
	{
		...
		var check_isRing = new FlxUICheckBox(10, 43, null, null, "Ring", 100);
		check_isRing.checked = _song.isRing;
		check_isRing.callback = function()
		{
			_song.isRing = check_isRing.checked;
			MusicBeatState.resetState();
			trace("isRing Checked!");
		};
		...
		if(skin == null) skin = '';
		if (isRing)
			noteSkinInputText = new FlxUIInputText(player2DropDown.x, player2DropDown.y + 50, 150, skin, 10);
		else
			noteSkinInputText = new FlxUIInputText(player2DropDown.x, player2DropDown.y + 50, 150, skin, 8);
			
		blockPressWhileTypingOn.push(noteSkinInputText);
		if (isRing)
			noteSplashesInputText = new FlxUIInputText(noteSkinInputText.x, noteSkinInputText.y + 35, 150, _song.splashSkin, 10);
		else
		...
		tab_group_song.add(check_isRing);
	...
	override function update(elapsed:Float)
	{
		...
		if(!blockInput) {
			FlxG.sound.muteKeys = vlc.Cutscenes.muteKeys;
			FlxG.sound.volumeDownKeys = vlc.Cutscenes.volumeDownKeys;
			FlxG.sound.volumeUpKeys = vlc.Cutscenes.volumeUpKeys;
		...
		if (!blockInput)
		{
			...
			{
				autosaveSong();
				LoadingState.loadAndSwitchState(new editors.BuggyEditorPlayState(sectionStartTime()));
			}
		...
		curRenderedNotes.forEachAlive(function(note:Note) {
			...
			if(curSelectedNote != null) {
				...
				if(noteDataToCheck > -1 && note.mustPress != _song.notes[curSection].mustHitSection) noteDataToCheck += bebra;
			...
			if(note.strumTime <= Conductor.songPosition) {
				...
				if(note.strumTime > lastConductorPos && FlxG.sound.music.playing && note.noteData > -1) {
					...
					var noteDataToCheck:Int = note.noteData % gayshit;
					if(noteDataToCheck > -1 && note.mustPress != _song.notes[curSection].mustHitSection) noteDataToCheck += gayshit;
						strumLineNotes.members[noteDataToCheck].playAnim('confirm', true);
						strumLineNotes.members[noteDataToCheck].resetAnim = (note.sustainLength / 1000) + 0.15;
					
					//bf
					if(note.noteType != 'Fatal Note' && note.noteType != 'Fatal Note Alt' && note.noteType != 'Hex Note' && note.noteType != 'Hurt Note' && note.noteType != 'Phantom Note') {
						if(!isRing && noteDataToCheck == 0 && note.mustPress || !isRing && noteDataToCheck == 4 && note.mustPress || isRing && noteDataToCheck == 0 && note.mustPress || isRing && noteDataToCheck == 5 && note.mustPress) {
							gf.animation.play('singLEFT', true);
							gf.idleSuffix = '-nothing';
							bfLeft = true;
							var bfLeft1 = new FlxTimer().start(1, function(tmr:FlxTimer)
							{
									bfLeft = false;
							});	
						}
						if(!isRing && noteDataToCheck == 1 && note.mustPress || !isRing && noteDataToCheck == 5 && note.mustPress || isRing && noteDataToCheck == 1 && note.mustPress || isRing && noteDataToCheck == 6 && note.mustPress) {
							gf.animation.play('singDOWN', true);
							gf.idleSuffix = '-nothing';
							bfDown = true;
							var bfDown1 = new FlxTimer().start(1, function(tmr:FlxTimer)
							{
									bfDown = false;
							});
						}
						if(!isRing && noteDataToCheck == 2 && note.mustPress || !isRing && noteDataToCheck == 6 && note.mustPress || isRing && noteDataToCheck == 3 && note.mustPress || isRing && noteDataToCheck == 8 && note.mustPress) {
							gf.animation.play('singUP', true);
							gf.idleSuffix = '-nothing';
							bfUp = true;
							var bfUp1 = new FlxTimer().start(1, function(tmr:FlxTimer)
							{
									bfUp = false;
							});
						}
						if(!isRing && noteDataToCheck == 3 && note.mustPress || !isRing && noteDataToCheck == 7 && note.mustPress || isRing && noteDataToCheck == 4 && note.mustPress || isRing && noteDataToCheck == 9 && note.mustPress) {
							gf.animation.play('singRIGHT', true);
							gf.idleSuffix = '-nothing';
							bfRight = true;
							var bfRight1 = new FlxTimer().start(1, function(tmr:FlxTimer)
							{
									bfRight = false;
							});
						}
					...
					if(note.noteType != 'Fatal Note' && note.noteType != 'Fatal Note Alt' && note.noteType != 'Hex Note' && note.noteType != 'Hurt Note' && note.noteType != 'Phantom Note') {
						if(!isRing && noteDataToCheck == 0 && !note.mustPress || !isRing && noteDataToCheck == 4 && !note.mustPress || isRing && noteDataToCheck == 0 && !note.mustPress || isRing && noteDataToCheck == 5 && !note.mustPress) {
							dad.animation.play('singLEFT', true);
							dad.idleSuffix = '-nothing';
							dadLeft = true;
							dad.x = 59;
							var dadLeft1 = new FlxTimer().start(1, function(tmr:FlxTimer)
							{
								dadLeft = false;
							});
						}
						if(!isRing && noteDataToCheck == 1 && !note.mustPress || !isRing && noteDataToCheck == 5 && !note.mustPress || isRing && noteDataToCheck == 1 && !note.mustPress || isRing && noteDataToCheck == 6 && !note.mustPress) {
							dad.animation.play('singDOWN', true);
							dad.idleSuffix = '-nothing';
							dad.x = 69;
							dadDown = true;
							var dadDown1 = new FlxTimer().start(1, function(tmr:FlxTimer)
							{
								dadDown = false;
							});
						}
						if(!isRing && noteDataToCheck == 2 && !note.mustPress || !isRing && noteDataToCheck == 6 && !note.mustPress || isRing && noteDataToCheck == 3 && !note.mustPress || isRing && noteDataToCheck == 8 && !note.mustPress) {
							dad.animation.play('singUP', true);
							dad.idleSuffix = '-nothing';
							dad.x = 69;
							dadUp = true;
							var dadUp1 = new FlxTimer().start(1, function(tmr:FlxTimer)
							{
								dadUp = false;
							});
						}
						if(!isRing && noteDataToCheck == 3 && !note.mustPress || !isRing && noteDataToCheck == 7 && !note.mustPress || isRing && noteDataToCheck == 4 && !note.mustPress || isRing && noteDataToCheck == 9 && !note.mustPress) {
							dad.animation.play('singRIGHT', true);
							dad.idleSuffix = '-nothing';
							dadRight = true;
							dad.x = 75;
							var dadRight1 = new FlxTimer().start(1, function(tmr:FlxTimer)
							{
								dadRight = false;
							});
						}
					...
					if(note.noteType != 'Fatal Note' && note.noteType != 'Fatal Note Alt' && note.noteType != 'Hex Note' && note.noteType != 'Hurt Note' && note.noteType != 'Phantom Note') {
						...
						if (playSoundBf.checked) {
							FlxG.sound.play(Paths.sound('noteHitPlayer'));
						}
						var bfidle1 = new FlxTimer().start(1, function(tmr:FlxTimer)
						{
							if (bfRight == false && bfUp == false && bfLeft == false && bfDown == false) 
							{
								bfLeft = false;
								bfRight = false;
								bfUp = false;
								bfDown = false;
								var bfidle2 = new FlxTimer().start(2, function(tmr:FlxTimer)
									{
									if(bfRight == false && bfUp == false && bfLeft == false && bfDown == false) {
										if (bfIdle) {
						...
						if (playSoundDad.checked) {
							FlxG.sound.play(Paths.sound('noteHitOpponent'));
						}
					
						var dadidle1 = new FlxTimer().start(1, function(tmr:FlxTimer)
						{
							if (dadRight == false && dadUp == false && dadLeft == false && dadDown == false) 
							{
								dadLeft = false;
								dadRight = false;
								dadUp = false;
								dadDown = false;
								var dadidle2 = new FlxTimer().start(2, function(tmr:FlxTimer)
									{
									if(dadRight == false && dadUp == false && dadLeft == false && dadDown == false) {
										if (dadIdle) {
											dad.x = 69;
	...
	function reloadGridLayer() {
		...
		gridLayer.clear();
		gridBG = FlxGridOverlay.create(GRID_SIZE, GRID_SIZE, GRID_SIZE * omg2, Std.int(GRID_SIZE * 32 * zoomList[curZoom]));
		...
		var gridBlack:FlxSprite = new FlxSprite(0, gridBG.height / 2).makeGraphic(Std.int(GRID_SIZE * omg2), Std.int(gridBG.height / 2), FlxColor.BLACK);
		gridBlack.alpha = 0.4;
		gridLayer.add(gridBlack);

		var gridBlackLine:FlxSprite = new FlxSprite(gridBG.x + gridBG.width - (GRID_SIZE * omg)).makeGraphic(2, Std.int(gridBG.height), FlxColor.BLACK);
		gridLayer.add(gridBlackLine);
		
		for (i in 1...omg){
		var beatsep1:FlxSprite = new FlxSprite(gridBG.x,(GRID_SIZE * (omg*curZoom))*i).makeGraphic(Std.int(gridBG.width), 1, 0x44FF0000);
	...
	function updateWaveform() {
		...
		if(waveformPrinted) {
			waveformSprite.makeGraphic(Std.int(GRID_SIZE * amogus), Std.int(gridBG.height), 0x00FFFFFF);
		...
		while (index < (waveBytes.length - 1))
		{
			...
			if ((index % samplesPerRow) == 0)
			{
				...
				waveformSprite.pixels.fillRect(new Rectangle(Std.int((GRID_SIZE * imposta) - pixelsMin), drawIndex, pixelsMin + pixelsMax, 1), FlxColor.BLUE);
				drawIndex++;
	...
	function loadHealthIconFromCharacter(char:String) {
		...
		var json:objects.Character.CharacterFile = cast Json.parse(rawJson);
	...
	function updateGrid():Void
	{
		...
		for (i in _song.notes[curSection].sectionNotes)
		{
			...
			if(i[3] != null && note.noteType != null && note.noteType.length > 0) {
				...
				var daText:AttachedFilxelText = new AttachedFilxelText(0, 0, 100, theType, 24);
			...
			var abobus:Int = 3;
			if (isRing) abobus = 4;
			if(i[1] > abobus) note.mustPress = !note.mustPress;
		}
		...
		for (i in _song.events)
		{
			if(endThing > i[0] && i[0] >= startThing)
			{
				...
				var daText:AttachedFilxelText = new AttachedFilxelText(0, 0, 400, text, 12);
	...
	function setupNoteData(i:Array<Dynamic>, isNextSection:Bool):Note
	{
		...
		var note:Note = new Note(daStrumTime, daNoteInfo % sussy, null, null, true);
	...
	function setupSusNote(note:Note):FlxSprite {
		...
		if (isRing)
			spr = new FlxSprite(note.x + (GRID_SIZE * 0.5) - 4, note.y + GRID_SIZE / 2).makeGraphic(10, height);
		else
			spr = new FlxSprite(note.x + (GRID_SIZE * 0.5) - 4, note.y + GRID_SIZE / 2).makeGraphic(8, height);
	...
	function selectNote(note:Note):Void
	{
		...
		{	
			var killmeplease:Int = 4;
			if (isRing) killmeplease = 5;
			
			if(note.mustPress != _song.notes[curSection].mustHitSection) noteDataToCheck += killmeplease;
			for (i in _song.notes[curSection].sectionNotes)
			{
	...
	function deleteNote(note:Note):Void
	{
		...
		var ihatethatshit:Int = 4;
		if (isRing) ihatethatshit = 5;
		
		if(noteDataToCheck > -1 && note.mustPress != _song.notes[curSection].mustHitSection) noteDataToCheck += ihatethatshit;
	...
	public function doANoteThing(cs, d, style){
		...
		if(strumLineNotes.members[d].overlaps(curRenderedNotes))
		{
			curRenderedNotes.forEachAlive(function(note:Note)
			{
				var yesItsAgainShittyVar:Int = 4;
				if (isRing) yesItsAgainShittyVar = 5;
				if (note.overlapsPoint(new FlxPoint(strumLineNotes.members[d].x + 1,strumLine.y+1)) && note.noteData == d%yesItsAgainShittyVar)
				{
							//trace('tryin to delete note...');
	...
	//	undos.push(newsong);
		...
		{
			_song.notes[curSection].sectionNotes.push([noteStrum, (noteData + WTFisTHAT) % WTFisTHAT * 2, noteSus, noteTypeIntMap.get(daType)]);
		}
	...
	private function saveEvents()
	{
		...
		var eventsSong:SwagSong = {
			...
			bfEncore: _song.bfEncore,
			gfEncore: _song.gfEncore,
			bfSkin: _song.bfSkin,
			gfSkin: _song.gfSkin,
			stage: _song.stage,
			validScore: false
...
class AttachedFilxelText extends FlxText
{
