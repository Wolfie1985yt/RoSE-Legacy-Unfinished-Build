	...
	public function new()
	{
		...
		switch(FlxG.random.int(1, 7)) {
			case 1:
				...
				#if desktop video.play #else video.playVideo #end(Paths.video('SanicGameOvers/1'));
				#if desktop
				video.volume = 300;
				#end
			case 2:
				...
				ClientPrefs.saveSettings();
				#if desktop video.play #else video.playVideo #end(Paths.video('SanicGameOvers/2'));
				#if desktop
				video.volume = 300;
				#end
			case 3:
				...
				ClientPrefs.saveSettings();
				#if desktop video.play #else video.playVideo #end(Paths.video('SanicGameOvers/3'));
				#if desktop
				video.volume = 300;
				#end
			case 4:
				...
				ClientPrefs.saveSettings();
				#if desktop video.play #else video.playVideo #end(Paths.video('SanicGameOvers/4'));
				#if desktop
				video.volume = 300;
				#end
			case 5:
				...
				ClientPrefs.saveSettings();
				#if desktop video.play #else video.playVideo #end(Paths.video('SanicGameOvers/5'));
				#if desktop
				video.volume = 300;
				#end
			case 6:
				...
				ClientPrefs.saveSettings();
				#if desktop video.play #else video.playVideo #end(Paths.video('SanicGameOvers/6'));
				#if desktop
				video.volume = 300;
				#end
			case 7:
				...
				ClientPrefs.saveSettings();
				#if desktop video.play #else video.playVideo #end(Paths.video('SanicGameOvers/7'));
				#if desktop
				video.volume = 300;
				#end
		}
