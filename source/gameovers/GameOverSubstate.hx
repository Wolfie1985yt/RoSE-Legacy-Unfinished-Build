...
class GameOverSubstate extends MusicBeatSubstate
{
	...
	var sonicDEATH:objects.SonicDeathAnimation;
	...
	override function create()
	{
		...
		if (PlayState.instance.defaultCamZoom >= 0.5) {
	...
	public function new(x:Float, y:Float, camX:Float, camY:Float)
	{
		...
		if (PlayState.SONG.song == 'too-slow' || PlayState.SONG.song == 'you-cant-run' || PlayState.SONG.song == 'triple-trouble' || PlayState.SONG.song == 'final-escape' || PlayState.SONG.song == 'too-slow-encore' || PlayState.SONG.song == 'too-slow-encore-alt' || PlayState.SONG.song == 'you-cant-run-encore' || PlayState.SONG.song == 'triple-trouble-encore' || PlayState.SONG.song == 'hill-of-the-void') {
			sonicDEATH = new objects.SonicDeathAnimation(boyfriend.x - 125, boyfriend.y - 350);
	...
	override function update(elapsed:Float)
	{
		...
		if (PlayState.SONG.song.toLowerCase() != 'fight-or-flight' && PlayState.SONG.song.toLowerCase() != 'haze' && PlayState.SONG.song.toLowerCase() != 'marauder') {
	...
	function coolStartDeath(?volume:Float = 1):Void
	{
		...
		switch(song) {
			...
			case 'too-slow-encore':
				FlxG.sound.play(Paths.sound('VoiceLines/XenoTSELines/' + FlxG.random.int(1, 10), 'exe'));
			case 'too-slow-encore-alt':
				FlxG.sound.play(Paths.sound('VoiceLines/GrimboLines/' + FlxG.random.int(1, 8), 'exe'));
			case 'you-cant-run', 'final-escape':
				FlxG.sound.play(Paths.sound('VoiceLines/XenoYCRLines/' + FlxG.random.int(1, 9), 'exe'));
			case 'you-cant-run-encore', 'final-escape-encore':
				FlxG.sound.play(Paths.sound('VoiceLines/XenoYCRELines/' + FlxG.random.int(1, 9), 'exe'));
			case 'triple-trouble':
				FlxG.sound.play(Paths.sound('VoiceLines/XenoTTLines/' + FlxG.random.int(1, 12), 'exe'));
			case 'triple-trouble-encore':
				FlxG.sound.play(Paths.sound('VoiceLines/XenoTTELines/' + FlxG.random.int(1, 12), 'exe'));
			case 'hill-of-the-void':
				FlxG.sound.play(Paths.sound('VoiceLines/HOTVLines/' + FlxG.random.int(1, 5), 'exe'));
			case 'face-off', 'ice-cap':
				FlxG.sound.play(Paths.sound('VoiceLines/LookALikeLines/' + FlxG.random.int(1, 8), 'exe'));
			case 'coulrophobia':
				FlxG.sound.play(Paths.sound('VoiceLines/RosyALTLines/' + FlxG.random.int(1, 7), 'exe'));
			case 'broken-heart':
			...
			case 'goddess':
				FlxG.sound.play(Paths.sound('VoiceLines/SallyALTLines/' + FlxG.random.int(1, 9), 'exe'));
			case 'endless', 'endless-og':
				FlxG.sound.play(Paths.sound('VoiceLines/MajinLines/' + FlxG.random.int(1, 8), 'exe'));
			case 'endless-jp':
				FlxG.sound.play(Paths.sound('VoiceLines/MajinJPLines/' + FlxG.random.int(1, 6), 'exe'));
			case 'endless-us':
				FlxG.sound.play(Paths.sound('VoiceLines/MajinUSLines/' + FlxG.random.int(1, 8), 'exe'));
			case 'endless-encore':
				FlxG.sound.play(Paths.sound('VoiceLines/MajinEncoreLines/' + FlxG.random.int(1, 10), 'exe'));
			case 'endeavors', 'endeavors-og':
				FlxG.sound.play(Paths.sound('VoiceLines/BuffMajinLines/' + FlxG.random.int(1, 11), 'exe'));
			case 'execution', 'cycles', 'hellbent':
				FlxG.sound.play(Paths.sound('VoiceLines/LordXLines/' + FlxG.random.int(1, 11), 'exe'));
			case 'fate':
				FlxG.sound.play(Paths.sound('VoiceLines/LordFateLines/' + FlxG.random.int(1, 9), 'exe'));
			case 'gotta-go':
				FlxG.sound.play(Paths.sound('VoiceLines/LordGottaLines/' + FlxG.random.int(1, 9), 'exe'));
			case 'judgement':
				FlxG.sound.play(Paths.sound('VoiceLines/LordJudgementLines/' + FlxG.random.int(1, 7), 'exe'));
			case 'cycles-encore':
				FlxG.sound.play(Paths.sound('VoiceLines/LordEncoreLines/' + FlxG.random.int(1, 9), 'exe'));
			case 'sunshine':
				FlxG.sound.play(Paths.sound('VoiceLines/TailsDollLines/' + FlxG.random.int(1, 5), 'exe'));
			case 'soulless':
				FlxG.sound.play(Paths.sound('VoiceLines/TailsDollSoulLines/' + FlxG.random.int(1, 7), 'exe'));
			case 'sunshine-encore':
				FlxG.sound.play(Paths.sound('VoiceLines/TailsDollEncoreLines/' + FlxG.random.int(1, 9), 'exe'));
			case 'chaos', 'terror':
				FlxG.sound.play(Paths.sound('VoiceLines/FleetLines/' + FlxG.random.int(1, 11), 'exe'));
			case 'chaos-encore':
				FlxG.sound.play(Paths.sound('VoiceLines/FleetEncoreLines/' + FlxG.random.int(1, 9), 'exe'));
			case 'faker':
				FlxG.sound.play(Paths.sound('VoiceLines/FakerLines/' + FlxG.random.int(1, 7), 'exe'));
			case 'black-sun', 'godspeed':
				FlxG.sound.play(Paths.sound('VoiceLines/ExeLines/' + FlxG.random.int(1, 8), 'exe'));
			case 'faker-encore':
				FlxG.sound.play(Paths.sound('VoiceLines/ExeEncoreLines/' + FlxG.random.int(1, 8), 'exe'));
			case 'missiletoe':
			...
			case 'fatality', 'unresponsive':
				FlxG.sound.play(Paths.sound('VoiceLines/FatalErrorLines/' + FlxG.random.int(1, 10), 'exe'));
			case 'critical-error':
				FlxG.sound.play(Paths.sound('VoiceLines/CriticalErrorLines/' + FlxG.random.int(1, 8), 'exe'));
			case 'fatality-encore':
				FlxG.sound.play(Paths.sound('VoiceLines/FatalEncoreLines/' + FlxG.random.int(1, 9), 'exe'));
			case 'prey' | 'prey-good-future':
				FlxG.sound.play(Paths.sound('VoiceLines/FurnaceLines/' + FlxG.random.int(1, 6), 'exe'));
			case 'fight-or-flight':
				FlxG.sound.play(Paths.sound('VoiceLines/StarvedLines/' + FlxG.random.int(1, 8), 'exe'));
			case 'relax', 'round-a-bout', 'no-way-out':
				FlxG.sound.play(Paths.sound('VoiceLines/NeedlemouseLines/' + FlxG.random.int(1, 10), 'exe'));
			case 'spike-trap':
				FlxG.sound.play(Paths.sound('VoiceLines/NeedlemouseAngerLines/' + FlxG.random.int(1, 7), 'exe'));
			case 'round-a-bout-encore':
				FlxG.sound.play(Paths.sound('VoiceLines/ShadowmouseLines/' + FlxG.random.int(1, 7), 'exe'));
			case 'her-world', 'her-world-old':
				FlxG.sound.play(Paths.sound('VoiceLines/LutherLines/' + FlxG.random.int(1, 6), 'exe'));
			...
			case 'uh-oh':
				FlxG.sound.play(Paths.sound('VoiceLines/DemogriLines/' + FlxG.random.int(1, 9), 'exe'));
			case 'digitalized', 'substantial':
				FlxG.sound.play(Paths.sound('VoiceLines/XTerionLines/' + FlxG.random.int(1, 9), 'exe'));
			case 'hollow', 'hollow-old':
				FlxG.sound.play(Paths.sound('VoiceLines/DevoidLines/' + FlxG.random.int(1, 8), 'exe'));
			case 'empty':
				FlxG.sound.play(Paths.sound('VoiceLines/DevoidMaskLines/' + FlxG.random.int(1, 7), 'exe'));
			case 'hollow-encore':
				FlxG.sound.play(Paths.sound('VoiceLines/DevoidEncoreLines/' + FlxG.random.int(1, 7), 'exe'));
			case 'burning', 'burning-og':
			...
			case 'extricate-hex':
				FlxG.sound.play(Paths.sound('VoiceLines/CurseHappyLines/' + FlxG.random.int(1, 5), 'exe'));
			case 'unblessful-hedgehog':
				FlxG.sound.play(Paths.sound('VoiceLines/CurseAngryLines/' + FlxG.random.int(1, 5), 'exe'));
			case 'found-you':
				FlxG.sound.play(Paths.sound('VoiceLines/NormalLines/' + FlxG.random.int(1, 9), 'exe'));
			case 'genesis', 'proverbs':
				FlxG.sound.play(Paths.sound('VoiceLines/ApollyonFakeLines/' + FlxG.random.int(1, 7), 'exe'));
			case 'corinthians', 'perdition-apollyon':
			...
			case 'perdition', 'infernal-demise':
				FlxG.sound.play(Paths.sound('VoiceLines/SatanosLines/' + FlxG.random.int(1, 6), 'exe'));
			case 'expulsion', 'exuberant':
				FlxG.sound.play(Paths.sound('VoiceLines/EducatorLines/' + FlxG.random.int(1, 12), 'exe'));
			...
			case 'color-blind', 'color-blind-old':
				FlxG.sound.play(Paths.sound('VoiceLines/MonoLines/' + FlxG.random.int(1, 9), 'exe'));
			case 'color-blind-encore':
				FlxG.sound.play(Paths.sound('VoiceLines/MonoEncoreLines/' + FlxG.random.int(1, 6), 'exe'));
			case 'miasma':
				FlxG.sound.play(Paths.sound('VoiceLines/DSKLines/' + FlxG.random.int(1, 7), 'exe'));
			case 'universal-collapse', 'planestrider', 'planestrider-annie-take':
				FlxG.sound.play(Paths.sound('VoiceLines/OMWLines/' + FlxG.random.int(1, 9), 'exe'));
			case 'life-and-death':
				FlxG.sound.play(Paths.sound('VoiceLines/BratwurstLines/' + FlxG.random.int(1, 8), 'exe'));
			case 'gods-will':
				FlxG.sound.play(Paths.sound('VoiceLines/Bratwurst2ndLines/' + FlxG.random.int(1, 8), 'exe'));
			case 'fake-baby':
				FlxG.sound.play(Paths.sound('VoiceLines/NMILines/' + FlxG.random.int(1, 10), 'exe'));
			case 'envy':
				FlxG.sound.play(Paths.sound('VoiceLines/GrimewareLines/' + FlxG.random.int(1, 12), 'exe'));
			case 'bloodstorm', 'sharpy-showdown':
				FlxG.sound.play(Paths.sound('VoiceLines/ExetiorLines/' + FlxG.random.int(1, 9), 'exe'));
			case 'call-of-justice', 'gotta-go-og', 'call-of-justice-old':
				FlxG.sound.play(Paths.sound('VoiceLines/BatmanLines/' + FlxG.random.int(1, 10), 'exe'));
			case 'shocker', 'extreme-zap', 'thunderbolt':
				FlxG.sound.play(Paths.sound('VoiceLines/SonichuLines/' + FlxG.random.int(1, 8), 'exe'));
			case 'ugly':
			...
			case 'animosity', 'reunion':
				FlxG.sound.play(Paths.sound('VoiceLines/MerphiLines/' + FlxG.random.int(1, 25), 'exe'));
			case 'old-ycr-slaps':
			...
			case 'flashcard':
				FlxG.sound.play(Paths.sound('VoiceLines/SoinkLines/' + FlxG.random.int(1, 9), 'exe'));
			case 'slaughter':
				FlxG.sound.play(Paths.sound('VoiceLines/PalLines/' + FlxG.random.int(1, 12), 'exe'));
			case 'wentzlau':
				FlxG.sound.play(Paths.sound('VoiceLines/TanicLines/' + FlxG.random.int(1, 7), 'exe'));
			case 'needlematic':
				FlxG.sound.play(Paths.sound('VoiceLines/RatonAgujaLines/' + FlxG.random.int(1, 8), 'exe'));
			case 'hedge-draft':
				FlxG.sound.play(Paths.sound('VoiceLines/SketchLines/' + FlxG.random.int(1, 12), 'exe'));
			case 'carnal-craving':
				FlxG.sound.play(Paths.sound('VoiceLines/GrimboobaLines/' + FlxG.random.int(1, 12), 'exe'));
			case 'for-you':
				FlxG.sound.play(Paths.sound('VoiceLines/LizLines/' + FlxG.random.int(1, 4), 'exe'));
		}
