...
class EncoreState extends MusicBeatState
{
	...
	var pcoverBorders:FlxTypedSpriteGroup<FlxSprite>;
	var mcoverBorders:FlxTypedSpriteGroup<FlxSprite>;
	...
	override function create()
	{
		...
		pcoverBorders = new FlxTypedSpriteGroup<FlxSprite>();
		mcoverBorders = new FlxTypedSpriteGroup<FlxSprite>();
		...
		for (i in 0...songArray.length)
		{
			...
			songRate1 = Highscore.getRating(songArray[i].toLowerCase(),1);
			
			if ((Highscore.getRating(songArray[i].toLowerCase(),1)) == 0) 
				songMiss1 = 1;
			else 
				songMiss1 = Highscore.getMisses(songArray[i].toLowerCase(),1);

			var percentRating:Float = (songRate1*10);
			var totalMisses:Float = (songMiss1);
			if (totalMisses == 0 && percentRating > 0) {
				...
				var pcover:FlxSprite = new FlxSprite(sus * 780, 0).loadGraphic(Paths.image('freeplay-encore/FCBoxEncore'));
				pcover.ID = i;
				pcover.visible = true;
			...
			if (percentRating == 10 && totalMisses == 0) {	
				var mcover:FlxSprite = new FlxSprite(sus * 780, 0).loadGraphic(Paths.image('freeplay-encore/accuracyEncore'));
				mcover.ID = i;
				mcover.visible = true;
			...
			//trace(songArray[i] + " Misses: " + totalMisses);
			//trace(songArray[i] + " Rating: " + percentRating);
			//trace("Faker encore = " + Highscore.getRating('faker-encore',1));
		...
		switch(curSelected) {
			...
			case 2:
				...
				charGRP.x = -1560;
				daStaticGRP.x = -1560;
				pcoverBorders.x = -1560;
				mcoverBorders.x = -1560;
			case 3:
				boxGRP.x = -2340;
				charGRP.x = -2340;
				daStaticGRP.x = -2340;
				pcoverBorders.x = -2340;
				mcoverBorders.x = -2340;
			case 4:
				boxGRP.x = -3120;
				charGRP.x = -3120;
				daStaticGRP.x = -3120;
				pcoverBorders.x = -3120;
				mcoverBorders.x = -3120;
			case 5:
				boxGRP.x = -3900;
				charGRP.x = -3900;
				daStaticGRP.x = -3900;
				pcoverBorders.x = -3900;
				mcoverBorders.x = -3900;
			case 6:
				boxGRP.x = -4680;
				charGRP.x = -4680;
				daStaticGRP.x = -4680;
				pcoverBorders.x = -4680;
				mcoverBorders.x = -4680;
			case 7:
				boxGRP.x = -5460;
				charGRP.x = -5460;
				daStaticGRP.x = -5460;
				pcoverBorders.x = -5460;
				mcoverBorders.x = -5460;
			case 8:
				boxGRP.x = -6240;
				charGRP.x = -6240;
				daStaticGRP.x = -6240;
				pcoverBorders.x = -6240;
				mcoverBorders.x = -6240;
			case 9:
				boxGRP.x = -7020;
				charGRP.x = -7020;
				daStaticGRP.x = -7020;
				pcoverBorders.x = -7020;
				mcoverBorders.x = -7020;
			case 10:
				boxGRP.x = -7800;
				charGRP.x = -7800;
				daStaticGRP.x = -7800;
				pcoverBorders.x = -7800;
				mcoverBorders.x = -7800;
			case 11:
				boxGRP.x = -8580;
				charGRP.x = -8580;
				daStaticGRP.x = -8580;
				pcoverBorders.x = -8580;
				mcoverBorders.x = -8580;
			case 12:
				boxGRP.x = -9360;
				charGRP.x = -9360;
				daStaticGRP.x = -9360;
				pcoverBorders.x = -9360;
				mcoverBorders.x = -9360;
		}
		...
		pcoverBorders.forEach(function(spr:FlxSprite){
			if(spr.ID == curSelected)
			{
				spr.alpha = 1;
				spr.scale.x = 1;
		...
		mcoverBorders.forEach(function(spr:FlxSprite){
			if(spr.ID == curSelected)
			{
				spr.alpha = 1;
				spr.scale.x = 1;
						...
						if (songtext.text != 'too slow encore') {
							if (!ClientPrefs.showCutscene.contains(ScoreSongSel)) {
								...
								if (!GoreContent) {
									...
									openSubState(new substates.GoreWarningSubstate(true, true, true, 1, true, 'encore', 'playstate'));
								...
								if (!GoreContent) {
									...
									new FlxTimer().start(1, function(tmr:FlxTimer) {
										#if !linux
										switch(ScoreSongSel) {
											case 'you-cant-run-encore': MusicBeatState.switchState(new vlc.Cutscenes('you-cant-run-encore', 'ycr-encore-intro', 0.3, 'Encore', 'you-cant-run-encore'));
											case 'fatality-encore':
												FlxG.fullscreen = true;
												MusicBeatState.switchState(new vlc.Cutscenes('Fatal Encore'));
										}
										#else
										LoadingState.loadAndSwitchState(new PlayState());
										#end
									...
									switch(ScoreSongSel) {
										case 'you-cant-run-encore': openSubState(new substates.GoreWarningSubstate(true, true, true, 1, true, 'encore', 'cutscene', 'you-cant-run-encore', 'ycr-encore-intro', 0.3, 'Encore', 'you-cant-run-encore'));
										case 'fatality-encore': openSubState(new substates.GoreWarningSubstate(true, true, true, 1, true, 'encore', 'cutscene', 'Fatal Encore'));
									}
									GoreWarningMenu = true;
								}
							}
	...
	function changeSelection(change:Int = 0, ?boom:String = '')
	{
		...
		switch(curSelected) {
			case 0:
				...
				FlxTween.tween(pcoverBorders ,{x: 0}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
				FlxTween.tween(mcoverBorders ,{x: 0}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
			case 1:
				...
				FlxTween.tween(pcoverBorders ,{x: -780}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
				FlxTween.tween(mcoverBorders ,{x: -780}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
			case 2:
				...
				FlxTween.tween(mcoverBorders ,{x: -1560}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
				FlxTween.tween(pcoverBorders ,{x: -1560}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
			case 3:
				...
				FlxTween.tween(mcoverBorders ,{x: -2340}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
				FlxTween.tween(pcoverBorders ,{x: -2340}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
			case 4:
				...
				FlxTween.tween(mcoverBorders ,{x: -3120}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
				FlxTween.tween(pcoverBorders ,{x: -3120}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
			case 5:
				...
				FlxTween.tween(mcoverBorders ,{x: -3900}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
				FlxTween.tween(pcoverBorders ,{x: -3900}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
			case 6:
				...
				FlxTween.tween(mcoverBorders ,{x: -4680}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
				FlxTween.tween(pcoverBorders ,{x: -4680}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
			case 7:
				...
				FlxTween.tween(mcoverBorders ,{x: -5460}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
				FlxTween.tween(pcoverBorders ,{x: -5460}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
			case 8:
				...
				FlxTween.tween(mcoverBorders ,{x: -6240}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
				FlxTween.tween(pcoverBorders ,{x: -6240}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
			case 9:
				...
				FlxTween.tween(mcoverBorders ,{x: -7020}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
				FlxTween.tween(pcoverBorders ,{x: -7020}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
			case 10:
				...
				FlxTween.tween(mcoverBorders ,{x: -7800}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
				FlxTween.tween(pcoverBorders ,{x: -7800}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
			case 11:
				...
				FlxTween.tween(mcoverBorders ,{x: -8580}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
				FlxTween.tween(pcoverBorders ,{x: -8580}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
			case 12:
				...
				FlxTween.tween(mcoverBorders ,{x: -9360}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
				FlxTween.tween(pcoverBorders ,{x: -9360}, 0.15, {ease: FlxEase.expoOut, onComplete: function(sus:FlxTween){}});
		}
		if (curSelected == 0) {
			scoretext.visible = false;
