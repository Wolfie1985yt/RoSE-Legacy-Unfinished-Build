			...
			if (controls.ACCEPT || ((FlxG.mouse.justPressedMiddle || FlxG.mouse.justPressed) && FlxG.mouse.overlaps(hitboxes))) {
				switch(curSelected) {
					case 1: if (ClientPrefs.UnlockedGalleryVideos.contains('sanic-1')) {
							...
							video.play(Paths.video('SanicGameOvers/1'));
							video.volume = 300;
							video.onEndReached.add(function() { MusicBeatState.switchState(new extras.GalleryModState()); video.dispose(); }, true);
							#else
					...
					case 2: if (ClientPrefs.UnlockedGalleryVideos.contains('sanic-2')) {
							...
							#if desktop
							var video:VideoHandler = new VideoHandler();
							video.play(Paths.video('SanicGameOvers/2'));
							video.volume = 300;
							video.onEndReached.add(function() { MusicBeatState.switchState(new extras.GalleryModState()); video.dispose(); }, true);
							#else
							var video:MP4Handler = new MP4Handler();
					...
					case 3: if (ClientPrefs.UnlockedGalleryVideos.contains('sanic-3')) {
							...
							#if desktop
							var video:VideoHandler = new VideoHandler();
							video.play(Paths.video('SanicGameOvers/3'));
							video.volume = 300;
							video.onEndReached.add(function() { MusicBeatState.switchState(new extras.GalleryModState()); video.dispose(); }, true);
							#else
							var video:MP4Handler = new MP4Handler();
					...
					case 4: if (ClientPrefs.UnlockedGalleryVideos.contains('sanic-4')) {
							...
							#if desktop
							var video:VideoHandler = new VideoHandler();
							video.play(Paths.video('SanicGameOvers/4'));
							video.volume = 300;
							video.onEndReached.add(function() { MusicBeatState.switchState(new extras.GalleryModState()); video.dispose(); }, true);
							#else
							var video:MP4Handler = new MP4Handler();
					...
					case 5: if (ClientPrefs.UnlockedGalleryVideos.contains('sanic-5')) {
							...
							#if desktop
							var video:VideoHandler = new VideoHandler();
							video.play(Paths.video('SanicGameOvers/5'));
							video.volume = 300;
							video.onEndReached.add(function() { MusicBeatState.switchState(new extras.GalleryModState()); video.dispose(); }, true);
							#else
							var video:MP4Handler = new MP4Handler();
					...
					case 6: if (ClientPrefs.UnlockedGalleryVideos.contains('sanic-6')) {
							...
							#if desktop
							var video:VideoHandler = new VideoHandler();
							video.play(Paths.video('SanicGameOvers/6'));
							video.volume = 300;
							video.onEndReached.add(function() { MusicBeatState.switchState(new extras.GalleryModState()); video.dispose(); }, true);
							#else
							var video:MP4Handler = new MP4Handler();
					...
					case 7: if (ClientPrefs.UnlockedGalleryVideos.contains('sanic-7')) {
							...
							#if desktop
							var video:VideoHandler = new VideoHandler();
							video.play(Paths.video('SanicGameOvers/7'));
							video.volume = 300;
							video.onEndReached.add(function() { MusicBeatState.switchState(new extras.GalleryModState()); video.dispose(); }, true);
							#else
							var video:MP4Handler = new MP4Handler();
					...
					case 8: if (ClientPrefs.UnlockedGalleryVideos.contains('sound-test-1')) {
							...
							#if desktop
							var video:VideoHandler = new VideoHandler();
							video.play(Paths.video('SoundTest/Musicians'));
							video.volume = 300;
							video.onEndReached.add(function() { MusicBeatState.switchState(new extras.GalleryModState()); video.dispose(); }, true);
							#else
							var video:MP4Handler = new MP4Handler();
					...
					case 9: if (ClientPrefs.UnlockedGalleryVideos.contains('sound-test-2')) {
							...
							#if desktop
							var video:VideoHandler = new VideoHandler();
							video.play(Paths.video('SoundTest/ArtFlex'));
							video.volume = 300;
							video.onEndReached.add(function() { MusicBeatState.switchState(new extras.GalleryModState()); video.dispose(); }, true);
							#else
							var video:MP4Handler = new MP4Handler();
					...
					case 10: if (ClientPrefs.UnlockedGalleryVideos.contains('sound-test-3')) {
							...
							#if desktop
							var video:VideoHandler = new VideoHandler();
							video.play(Paths.video('SoundTest/BeOneWithRestored'));
							video.volume = 300;
							video.onEndReached.add(function() { MusicBeatState.switchState(new extras.GalleryModState()); video.dispose(); }, true);
							#else
							var video:MP4Handler = new MP4Handler();
					...
					case 11: if (ClientPrefs.UnlockedGalleryVideos.contains('sound-test-4')) {
							...
							#if desktop
							var video:VideoHandler = new VideoHandler();
							video.play(Paths.video('SoundTest/GSBL'));
							video.volume = 300;
							video.onEndReached.add(function() { MusicBeatState.switchState(new extras.GalleryModState()); video.dispose(); }, true);
							#else
							var video:MP4Handler = new MP4Handler();
					...
					case 12: if (ClientPrefs.UnlockedGalleryVideos.contains('sound-test-5')) {
							...
							#if desktop
							var video:VideoHandler = new VideoHandler();
							video.play(Paths.video('SoundTest/SpiderSonic'));
							video.volume = 300;
							video.onEndReached.add(function() { MusicBeatState.switchState(new extras.GalleryModState()); video.dispose(); }, true);
							#else
							var video:MP4Handler = new MP4Handler();
					...
					case 13: if (ClientPrefs.UnlockedGalleryVideos.contains('sound-test-6')) {
							...
							#if desktop
							var video:VideoHandler = new VideoHandler();
							video.play(Paths.video('SoundTest/RestoredIsDead'));
							video.volume = 300;
							video.onEndReached.add(function() { MusicBeatState.switchState(new extras.GalleryModState()); video.dispose(); }, true);
							#else
							var video:MP4Handler = new MP4Handler();
