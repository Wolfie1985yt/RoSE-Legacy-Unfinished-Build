...
function onCreate()
	...
	addAnimationByPrefix('tvIcons', 'melthog0', 'Melthog0 0', 24, true);
	...
	addAnimationByPrefix('tvIcons', 'meltblob', 'MeltBlob 0', 24, true);
	...
	makeAnimatedLuaSprite('gfMelthog', 'characters/GF/Pixel/gf_rock', 1815, -215);
	scaleObject('gfMelthog', 9, 9);
	addAnimationByPrefix('gfMelthog', 'left', 'Left', 24, false);
	addAnimationByPrefix('gfMelthog', 'right', 'Right', 24, false);
	addAnimationByPrefix('gfMelthog', 'sad', 'Miss', 24, true);
	setScrollFactor('gfMelthog', 1, 1);
	setProperty('gfMelthog.antialiasing', false);
	setProperty('gfMelthog.alpha', 1);
	addLuaSprite('gfMelthog', true);

	makeAnimatedLuaSprite('gfMelting', 'characters/GF/Pixel/gf_rock_alt', 1815, -215);
	scaleObject('gfMelting', 9, 9);
	addAnimationByPrefix('gfMelting', 'left', 'Left', 12, false);
	addAnimationByPrefix('gfMelting', 'right', 'Right', 12, false);
	addAnimationByPrefix('gfMelting', 'sad', 'Miss', 24, true);
	setScrollFactor('gfMelting', 1, 1);
	setProperty('gfMelting.antialiasing', false);
	setProperty('gfMelting.alpha',0);
	addLuaSprite('gfMelting', true);
	...
	runHaxeCode([[
		...
		CloudAltSix = new FlxBackdrop(Paths.image('bgs/melt/alt/clouds/6'), 1, 1, true, false);
		CloudAltSix.x = -1500;
		CloudAltSix.y = -650;
		CloudAltSix.alpha = 0;
...
function onEvent(event, val1, val2)
	if event == 'Change Character' then
		if val1 == "1" or val1 == 'dad' or val1 == 'opponent' then
			...
			if val2 == 'confronting-melt' then
				objectPlayAnimation('tvIcons', 'melthogbf', true)
			end
			if val2 == 'Meltblob' then
				objectPlayAnimation('tvIcons', 'meltblob', true)
			end
		end
	end
end
...
function onStepHit()	
	if songName == "confronting" then
		...
		if curStep == 1422 then
			doTweenAlpha('gfTween10','gf',0.4,0.3,'linear')
		end
		...
		if curStep == 1627 then
			...
			doTweenAlpha('nuhuh','sonicHUD',0,0.3,'linear')
		end
		...
		if curStep == 1632 then
			...
			setProperty('flashingshit.alpha',1)
			doTweenAlpha('gfMelthogThing','gfMelthog',0,1,'linear')
			doTweenAlpha('flashingshit1','flashingshit',0,1,'linear')
			doTweenZoom('ZoomEvent2', 'camGame', 0.75, quadOut);
...
function onUpdate()
	...
	if followchars == true then
        ...
        if mustHitSection == false then
            ...
            if getProperty('boyfriend.animation.curAnim.name') == 'idle' or getProperty('boyfriend.animation.curAnim.name') == 'idle-alt' or getProperty('boyfriend.animation.curAnim.name') == 'dodgeR' or getProperty('boyfriend.animation.curAnim.name') == 'dodgeL' then
...
function onBeatHit()
	if curBeat % 1 == 0 and leftAnim == true then
		objectPlayAnimation('gfMelthog', 'left', false);
		objectPlayAnimation('gfMelting', 'left', false);
		leftAnim = false;
		rightAnim = true
	elseif curBeat % 1 == 0 and rightAnim == true then
		objectPlayAnimation('gfMelthog', 'right', false);
		objectPlayAnimation('gfMelting', 'right', false);
		rightAnim = false;
		leftAnim = true;
	end
end