...
function onUpdatePost()
	...
	if curStep == 1040 then
		...
		setProperty('boyfriendGroup.y',790)
		
		setProperty('dadGroup.x',75)
		setProperty('dadGroup.y',1002)
	end
	if curStep == 1296 then
		...
		setProperty('dadGroup.y',1500)
		setProperty('boyfriend.y',1630)
	end
	if curStep == 1424 then
		...
		setProperty('boyfriendGroup.x',900)
		setProperty('boyfriendGroup.y',280)
	...
	if curStep == 1556 then
		...
		triggerEvent('Change Character', 'dad', 'FrontViewSl4sh-tetra')
		triggerEvent('Change Character', 'bf', 'true-fatal-playable')
		
		setProperty('dad.x',550)
		setProperty('dad.y',1450)
		setProperty('boyfriend.x',1770)
		setProperty('boyfriend.y',1258)
		
		followchars = true;
	end
	if curStep == 2064 then
		followchars = false;
		triggerEvent('Change Character', 'dad', 'sl4sh-tetra')
		triggerEvent('Change Character', 'bf', 'fatal-error-playable')
		setObjectOrder('dadGroup',100)
		setObjectOrder('boyfriendGroup',101)
