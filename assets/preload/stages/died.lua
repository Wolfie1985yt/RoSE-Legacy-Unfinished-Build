...
function onUpdate(elapsed)
	if vineboom == true then	
        if mustHitSection == false then
			...
			if gfSection == false then
				if getProperty('boyfriend.animation.curAnim.name') == 'singLEFT' or getProperty('boyfriend.animation.curAnim.name') == 'singLEFT-alt' or getProperty('boyfriend.animation.curAnim.name') == 'singRIGHT' or getProperty('boyfriend.animation.curAnim.name') == 'singRIGHT-alt' or getProperty('boyfriend.animation.curAnim.name') == 'singUP' or getProperty('boyfriend.animation.curAnim.name') == 'singUP-alt' or getProperty('boyfriend.animation.curAnim.name') == 'singDOWN' or getProperty('boyfriend.animation.curAnim.name') == 'singDOWN-alt' or getProperty('boyfriend.animation.curAnim.name') == 'singLEFTmiss' or getProperty('boyfriend.animation.curAnim.name') == 'singLEFTmiss-alt'  or getProperty('boyfriend.animation.curAnim.name') == 'singRIGHTmiss' or getProperty('boyfriend.animation.curAnim.name') == 'singRIGHTmiss-alt' or getProperty('boyfriend.animation.curAnim.name') == 'singUPmiss' or getProperty('boyfriend.animation.curAnim.name') == 'singUPmiss-alt' or getProperty('boyfriend.animation.curAnim.name') == 'singDOWNmiss' or getProperty('boyfriend.animation.curAnim.name') == 'singDOWNmiss-alt' or getProperty('boyfriend.animation.curAnim.name') == 'idle' or getProperty('boyfriend.animation.curAnim.name') == 'idle-alt' then
	...
	if songName == "too-far" then
		...
		if curStep == 21 or curStep == 23 or curStep == 25 or curStep == 27 or curStep == 29 or curStep == 31 or curStep == 33 or curStep == 35 or curStep == 37 or curStep == 39 or curStep == 41 or curStep == 43 or curStep == 45 or curStep == 47 or curStep == 49 or curStep == 51 or curStep == 53 or curStep == 55 then
		...
		if curStep == 1088 then
			...
			doTweenAlpha('gf','gf',1,2.96,'elasticOut')
			doTweenX('1gfTween', 'gf', "450", 2.96,'elasticOut');
			doTweenX('1dadTween', 'dad', "-400", 2.96,'elasticOut');
