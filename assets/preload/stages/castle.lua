...
function onUpdate(elapsed)
	...
	if songName == "hellbent" then
		...
		if curStep == 256 then
			if getPropertyFromClass('backend.ClientPrefs', 'middleScroll') == true then
		...
		if curStep == 1120 or curStep == 1136 or curStep == 1152 or curStep == 1168 then
			if getPropertyFromClass('backend.ClientPrefs', 'PotatoOptimization') == false then
				doTweenAlpha('statttic','static',1,0.3,'linear')
			end
		end
		
		if curStep == 1128 or curStep == 1144 or curStep == 1160 then
			if getPropertyFromClass('backend.ClientPrefs', 'PotatoOptimization') == false then
		...
		if curStep == 1184 then
			...
			noteTweenAlpha('pplayerStrrums0',4 ,1 ,0.6, 'linear')
			noteTweenAlpha('pplayerStrrums1',5 ,1 ,0.6, 'linear')
			noteTweenAlpha('pplayerStrrums2',6 ,1 ,0.6, 'linear')
			noteTweenAlpha('pplayerStrrums3',7 ,1 ,0.6, 'linear')
