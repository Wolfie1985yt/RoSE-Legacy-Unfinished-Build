...
function onCreate()
	...
	if songName == 'jingle-hells' and getPropertyFromClass('backend.ClientPrefs', 'Optimization') == false then
	...
	if songName == 'slaybells' and getPropertyFromClass('backend.ClientPrefs', 'Optimization') == false then
		makeAnimatedLuaSprite('requital', 'bgs/christmas/christma-requital', 1000, 960);
		setScrollFactor('requital', 1, 1);
		addAnimationByPrefix('requital', 'idle', 'Requital', 17, false);
		...
		addAnimationByPrefix('sanic', 'idle', 'Sanic', 17, false);
	...
	if songName == 'jingle-hells' and getPropertyFromClass('backend.ClientPrefs', 'Optimization') == false then
		...
		addAnimationByPrefix('melthog', 'idle', 'Melthog', 17, false);
		...
		addAnimationByPrefix('grimbo', 'idle', 'Grimbo/Luis', 17, false);
	...
	addAnimationByPrefix('fleetway', 'idle', 'Fleetway', 17, false);
	...
	addAnimationByPrefix('curse', 'idle', 'Curse', 17, false);
	setProperty('curse.antialiasing', true);
	addLuaSprite('curse', true);
		
	if songName == 'slaybells' and getPropertyFromClass('backend.ClientPrefs', 'Optimization') == false or songName == 'jingle-hells' and getPropertyFromClass('backend.ClientPrefs', 'Optimization') == false then		
		makeAnimatedLuaSprite('sunky', 'bgs/christmas/christma-sunky', 250, 1050);
		scaleObject('sunky', 1, 1);
		setScrollFactor('sunky', 0.8, 0.8);
		addAnimationByPrefix('sunky', 'idle', 'Sunky', 17, false);
		...
		addAnimationByPrefix('devoid', 'idle', 'Devoid', 17, false);
		...
		addAnimationByPrefix('rerun', 'idle', 'ReRun', 17, false);
	...
	if songName == 'jingle-hells' and getPropertyFromClass('backend.ClientPrefs', 'Optimization') == false then
		...
		addAnimationByPrefix('luther', 'idle', 'Luther', 17, false);
		...
		addAnimationByPrefix('needlemouse', 'idle', 'Needle', 17, false);
	...
	if songName == 'slaybells' and getPropertyFromClass('backend.ClientPrefs', 'Optimization') == false then
		...
		addAnimationByPrefix('snow-slaybells', 'idle', 'Snow Slaybells', 12, true);
	...
	if songName == 'jingle-hells' and getPropertyFromClass('backend.ClientPrefs', 'Optimization') == false then
		...
		addAnimationByPrefix('snow-jingle-hells', 'idle', 'Jingle Snow', 16, true);
	...
	if getPropertyFromClass('backend.ClientPrefs', 'PotatoOptimization') == true then
		if songName == 'slaybells' then
		xx = -280;
		yy = 800;
		xx2 = 580;
...
function onBeatHit()
	...
	if songName == "jingle-hells" and disco == true and (getPropertyFromClass('backend.ClientPrefs', 'flashing') == true) then
		if curBeat % 2 == 0 then
...
function onStepHit()
	...
	if curStep >= 18 and songName == 'missiletoe' then
		...
		local currentBeat = (songPos/400)*(bpm/120)
		doTweenY(dadTweenY, 'dad', 340-50*math.sin((currentBeat*0.25)*math.pi),0.001)
	end
	end
end
