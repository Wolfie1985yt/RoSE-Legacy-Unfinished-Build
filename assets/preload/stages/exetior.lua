local xx = 1350;
local yy = 1020; --1000 for bf and exetior
local ofs = 25;
local ofs2 = 25;
local xx2 = 1500;
local yy2 = 1020;
...
function onCreate()
	...
	makeLuaSprite('tv', 'bgs/exetior/p1/tv', 790, 110);
	scaleObject('tv', 1.2, 1.2);
	setScrollFactor('tv', 0.8, 0.9);
	...
	if getPropertyFromClass('backend.ClientPrefs', 'PotatoOptimization') == false then
		makeLuaSprite('floor', 'bgs/exetior/p1/floor', -290, 1350);
		scaleObject('floor', 1.2, 1.2);
		setScrollFactor('floor', 1, 1);
		setProperty('floor.antialiasing', true);
		addLuaSprite('floor', false);
		
		makeLuaSprite('pillar', 'bgs/exetior/p1/pillars', -545, -300);
		scaleObject('pillar', 1.2, 1.2);
		setScrollFactor('pillar', 0.8, 0.9);
		setProperty('pillar.antialiasing', true);
		addLuaSprite('pillar', false);
		
		makeLuaSprite('arch', 'bgs/exetior/p1/arch', 165, 135);
		scaleObject('arch', 1.2, 1.2);
		setScrollFactor('arch', 1, 1);
		setProperty('arch.antialiasing', true);
		addLuaSprite('arch', false);
		
		makeLuaSprite('walls', 'bgs/exetior/p1/crystal-walls', -200, -50);
		scaleObject('walls', 1.2, 1.2);
		setScrollFactor('walls', 0.7, 1);
		setProperty('walls.antialiasing', true);
		addLuaSprite('walls', true);
		
		--Phase 2
		makeLuaSprite('light2', 'bgs/exetior/p2/spotlight-2', -200, -700);
		...
		makeLuaSprite('light', 'bgs/exetior/p2/lights', -850, -800);
	...
	if songName == "sharpy-showdown" then
		...
		if curStep == 512 then
			...
			if getPropertyFromClass('backend.ClientPrefs', 'PotatoOptimization') == false then
				...
				setProperty('arch.alpha',0)
				setProperty('walls.alpha',0)
			end
		end
		if curStep == 640 then
			if getPropertyFromClass('backend.ClientPrefs', 'middleScroll') == true then
			...
			if getPropertyFromClass('backend.ClientPrefs', 'PotatoOptimization') == false then
				...
				setProperty('arch.alpha',1)
				setProperty('walls.alpha',1)
			end
		end
		if curStep == 896 then
