...
function onCreate()
	...
	addHaxeLibrary('backend.WinPaths');
	...
	makeAnimatedLuaSprite('phaseZerobg', 'bgs/fatal-encore/bg', -205, -67);
	...
	scaleObject('phaseZerobg', 2.3, 2.3)
	...
	runHaxeCode([[
		...
		if (game.UseWindowsDesktopFiles)
			files = backend.WinPaths.getDesktopFileNames(false, false, false, false, false);
		else
