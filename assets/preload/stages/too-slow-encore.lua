...
function onCreate()
	if songName == 'too-slow-encore' then
		if getPropertyFromClass('backend.ClientPrefs', 'downScroll') == false then
			makeAnimatedLuaSprite('icon', 'icons/icon-sonic-transanim', -70, 485);
			setScrollFactor('icon', 1, 1);
			addAnimationByPrefix('icon', 'idle', 'Icon 1', 24, false);
			addAnimationByPrefix('icon', 'idle2', 'Icon 2', 24, false);
			addAnimationByPrefix('icon', 'transform', 'Animation', 12, false);
			setProperty('icon.antialiasing', true);
			...
			makeAnimatedLuaSprite('icon', 'icons/icon-sonic-transanim', -70, -75);
			setScrollFactor('icon', 1, 1);
			addAnimationByPrefix('icon', 'idle', 'Icon 1', 24, false);
			addAnimationByPrefix('icon', 'idle2', 'Icon 2', 24, false);
			addAnimationByPrefix('icon', 'transform', 'Animation', 12, false);
	...
	if songName == 'too-slow-encore-alt' then
		if getPropertyFromClass('backend.ClientPrefs', 'downScroll') == false then
			makeAnimatedLuaSprite('icon', 'icons/icon-grimbo-trans', -30, 515);
			setScrollFactor('icon', 1, 1);
			addAnimationByPrefix('icon', 'idle', 'Icon 1', 24, false);
			addAnimationByPrefix('icon', 'idle2', 'Icon 2', 24, false);
			addAnimationByPrefix('icon', 'transform', 'Transformation', 24, false);
			setProperty('icon.antialiasing', true);
			scaleObject('icon', 1.2, 1.2)
			setScrollFactor('icon', 1, 1);
			setObjectCamera('icon', 'camHUD')
			...
			makeAnimatedLuaSprite('icon', 'icons/icon-grimbo-trans', -30, -35);
			setScrollFactor('icon', 1, 1);
			addAnimationByPrefix('icon', 'idle', 'Icon 1', 24, false);
			addAnimationByPrefix('icon', 'idle2', 'Icon 2', 24, false);
			addAnimationByPrefix('icon', 'transform', 'Transformation', 24, false);
...
function onSongStart()
	setObjectOrder('xenoEncUIthing',1)
	setObjectOrder('timeTxt',2)
	setObjectOrder('scoreTxt',3)
	setObjectOrder('xenoEncMissesTxt',4)
	setObjectOrder('xenoEncHealthBar',5)
	setObjectOrder('xenoEncHP',6)
	setObjectOrder('xenoEncIconP1',7)
	setObjectOrder('xenoEncIconP2',8)
...
function onUpdate(elapsed)
	...
	if songName == "too-slow-encore" then
		if curStep == 379 then
			objectPlayAnimation('icon', 'transform', true)
			setProperty('xenoEncIconP2.visible', false)
			setProperty('icon.visible', true)
		end
		if curStep == 400 then
			setProperty('icon.visible',false)
			setProperty('xenoEncIconP2.visible', true)
		end
		if curStep == 0 then
