...
function onCreate()
	if getPropertyFromClass('backend.ClientPrefs', 'PotatoOptimization') == false then
		...
		if getPropertyFromClass('backend.ClientPrefs', 'Optimization') == false then
			makeLuaSprite('bridgeB', 'bgs/sally-bg/hd/bridgeB', -1000, -300);
			...
			makeAnimatedLuaSprite('shadow', 'bgs/sally-bg/hd/shadow-alt', -1000, -450);
			...
			makeLuaSprite('bridgeF', 'bgs/sally-bg/hd/bridgeF', -1000, -200);
