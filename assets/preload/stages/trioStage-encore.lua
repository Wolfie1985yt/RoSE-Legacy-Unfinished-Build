...
function onUpdate(elapsed)
	...
	if songName == "triple-trouble-encore" then
		...
		if curStep == 516 or curStep == 772 or curStep == 1028 or curStep == 1350 or curStep == 2336 or curStep == 2765 or curStep == 3278 or curStep == 5719 then
			setProperty('flashingshit.alpha', 1)
			doTweenAlpha('flashCuzOfYes','flashingshit',0,1,'linear')
		end
		if curStep == 1150 then --Xeno P1
			beatOne = true;
			xx = 600;
			yy = -50;
			xx2 = 800;
		...
		if curStep == 2464 or curStep == 2566 or curStep == 2694 then
