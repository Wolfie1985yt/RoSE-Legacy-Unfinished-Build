...
function onCreate()
	...
	if getPropertyFromClass('backend.ClientPrefs', 'gore') == true then
	...
	makeAnimatedLuaSprite('GHZ_SKY_BLOODY', 'bgs/you-cant-run/GHZ_SKY_BLOODY', -1500, -550);
	addAnimationByPrefix('GHZ_SKY_BLOODY', 'idle', 'Blood BG', 12, true);
	scaleObject('GHZ_SKY_BLOODY', 7, 7);
	setScrollFactor('GHZ_SKY_BLOODY', 0.8, 0.8);
	setProperty('GHZ_SKY_BLOODY.antialiasing', false);
	addLuaSprite('GHZ_SKY_BLOODY', false);
	
	if getPropertyFromClass('backend.ClientPrefs', 'gore') == true then
		makeLuaSprite('GHZ_dead_and_dead', 'bgs/you-cant-run/GHZ_dead_and_dead', -1500, -50);
		scaleObject('GHZ_dead_and_dead', 6, 6);
		setScrollFactor('GHZ_dead_and_dead', 1, 1);
		setProperty('GHZ_dead_and_dead.antialiasing', false);
		addLuaSprite('GHZ_dead_and_dead', false);
	else
		makeLuaSprite('GHZ_dead_and_dead', 'bgs/you-cant-run/GHZ_dead_and_peace', -1500, -50);
		scaleObject('GHZ_dead_and_dead', 6, 6);
		setScrollFactor('GHZ_dead_and_dead', 1, 1);
		setProperty('GHZ_dead_and_dead.antialiasing', false);
		addLuaSprite('GHZ_dead_and_dead', false);
	...
	setProperty('GHZ_SKY_BLOODY.alpha', 0)
	setProperty('GHZ_dead_and_dead.alpha', 0)
...
function onUpdate(elapsed)
	if songName == "you-cant-run" then
		...
		if curStep == 656 then
			setProperty('GHZ_SKY.alpha', 0)
			setProperty('GHZ.alpha', 0)
			setProperty('GHZ_SKY_BLOODY.alpha', 1)
			setProperty('GHZ_dead_and_dead.alpha', 1)
		end
		if curStep == 784 then
