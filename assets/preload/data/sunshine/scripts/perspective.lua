function onCreate()
    makeLuaSprite("tdfloor", "bgs/tails-doll/floorreal", -1500, -1450)
    addLuaSprite("tdfloor", false)
	scaleObject("tdfloor", 3, 1.35, true)
	setPerspective("tdfloor", 0.7)
end

function onUpdate(elapsed)
	if curStep == 592 then
		setPerspective("tdfloor", 0)
	end
	if curStep == 880 then
		setPerspective("tdfloor", 0.7)
	end
