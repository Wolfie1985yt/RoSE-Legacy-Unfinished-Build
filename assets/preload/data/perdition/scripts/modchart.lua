...
function onUpdate(elapsed)
	...
	if getPropertyFromClass('backend.ClientPrefs', 'downScroll') == true then
		...
		if curStep == 944 then --m7
			noteTweenY("UpScrollSatanos1", 0, 565, 1.5, "linear")
			noteTweenY("UpScrollSatanos2", 1, 565, 1.5, "linear")
			noteTweenY("UpScrollSatanos3", 2, 565, 1.5, "linear")
			noteTweenY("UpScrollSatanos4", 3, 565, 1.5, "linear")
			noteTweenY("UpScrollBF1", 4, 565, 1.5, "linear")
			noteTweenY("UpScrollBF2", 5, 565, 1.5, "linear")
			noteTweenY("UpScrollBF3", 6, 565, 1.5, "linear")
			noteTweenY("UpScrollBF4", 7, 565, 1.5, "linear")
		...
		if curStep == 1200 then --m10
			noteTweenY("UpScrollSatanos1", 0, 565, 0.15, "BackIn")
			noteTweenY("UpScrollSatanos2", 1, 565, 0.15, "BackIn")
			noteTweenY("UpScrollSatanos3", 2, 565, 0.15, "BackIn")
			noteTweenY("UpScrollSatanos4", 3, 565, 0.15, "BackIn")
			...
			noteTweenY("UpScrollBF1", 4, 565, 0.15, "BackIn")
			noteTweenY("UpScrollBF2", 5, 565, 0.15, "BackIn")
			noteTweenY("UpScrollBF3", 6, 565, 0.15, "BackIn")
			noteTweenY("UpScrollBF4", 7, 565, 0.15, "BackIn")
		...
		if curStep == 1456 or curStep == 1488 or curStep == 1520 then --m11
			noteTweenY("UpScrollSatanos1", 0, 565, 0.05, "BackIn")
			noteTweenY("UpScrollSatanos2", 1, 565, 0.05, "BackIn")
			noteTweenY("UpScrollSatanos3", 2, 565, 0.05, "BackIn")
			noteTweenY("UpScrollSatanos4", 3, 565, 0.05, "BackIn")
			noteTweenY("UpScrollBF1", 4, 565, 0.05, "BackIn")
			noteTweenY("UpScrollBF2", 5, 565, 0.05, "BackIn")
			noteTweenY("UpScrollBF3", 6, 565, 0.05, "BackIn")
			noteTweenY("UpScrollBF4", 7, 565, 0.05, "BackIn")
		...
		if curStep == 1472 or curStep == 1504 or curStep == 1584 then --m12
			noteTweenY("DownScrollSatanos1", 0, 50, 0.05, "BackIn")
			noteTweenY("DownScrollSatanos2", 1, 50, 0.05, "BackIn")
			noteTweenY("DownScrollSatanos3", 2, 50, 0.05, "BackIn")
			noteTweenY("DownScrollSatanos4", 3, 50, 0.05, "BackIn")
			noteTweenY("DownScrollBF1", 4, 50, 0.05, "BackIn")
			noteTweenY("DownScrollBF2", 5, 50, 0.05, "BackIn")
			noteTweenY("DownScrollBF3", 6, 50, 0.05, "BackIn")
			noteTweenY("DownScrollBF4", 7, 50, 0.05, "BackIn")
		...
		if curStep == 1744 then --m15
			...
			noteTweenY("UpScrollSatanos1", 0, 565, 0.01, "linear")
			noteTweenY("UpScrollSatanos2", 1, 565, 0.01, "linear")
			noteTweenY("UpScrollSatanos3", 2, 565, 0.01, "linear")
			noteTweenY("UpScrollSatanos4", 3, 565, 0.01, "linear")

			noteTweenY("DownScrollBF1", 4, 50, 0.01, "linear")
			noteTweenY("DownScrollBF2", 5, 50, 0.01, "linear")
			noteTweenY("DownScrollBF3", 6, 50, 0.01, "linear")
			noteTweenY("DownScrollBF4", 7, 50, 0.01, "linear")
		end
		if curStep == 1868 then --m16
			setPropertyFromGroup('opponentStrums', 0, 'downScroll', true)
			setPropertyFromGroup('opponentStrums', 1, 'downScroll', true)
		...
		if curStep == 2432 then --m23
			...
			noteTweenY("UpScrollBF1", 4, 565, 0.01, "linear")
			noteTweenY("UpScrollBF2", 5, 565, 0.01, "linear")
			noteTweenY("UpScrollBF3", 6, 565, 0.01, "linear")
			noteTweenY("UpScrollBF4", 7, 565, 0.01, "linear")
		end
		if curStep == 2448 then --m24
			noteTweenX('NOSatanosX0', 0, -1000, 0.05, 'quartInOut')
			noteTweenX('NOSatanosX1', 1, -1000, 0.05, 'quartInOut')
		...
		if curStep == 2553 then --m27
			noteTweenY("SHHHH1", 4, -150, 0.0001, "linear")
			noteTweenY("SHHHH2", 5, -150, 0.0001, "linear")
			noteTweenY("SHHHH3", 6, -150, 0.0001, "linear")
			noteTweenY("SHHHH4", 7, -150, 0.0001, "linear")
		end
		if curStep == 2558 then --m28
			setPropertyFromGroup('playerStrums', 0, 'downScroll', false)
			setPropertyFromGroup('playerStrums', 1, 'downScroll', false)
			...
			noteTweenY("DownScrollBF1", 4, 50, 0.2, "linear")
			noteTweenY("DownScrollBF2", 5, 50, 0.2, "linear")
			noteTweenY("DownScrollBF3", 6, 50, 0.2, "linear")
			noteTweenY("DownScrollBF4", 7, 50, 0.2, "linear")
		end
		if curStep == 2576 then --m29
			noteTweenY("NOBFY1", 4, -300, 0.01, "linear")
			noteTweenY("NOBFY2", 5, -300, 0.01, "linear")
			noteTweenY("NOBFY3", 6, -300, 0.01, "linear")
			noteTweenY("NOBFY4", 7, -300, 0.01, "linear")
		end
		if curStep == 2579 then --m30
			noteTweenY("SHHHH1", 4, 800, 0.0001, "linear")
			noteTweenY("SHHHH2", 5, 800, 0.0001, "linear")
		...
		if curStep == 2581 then --m31
			...
			setPropertyFromGroup('playerStrums', 2, 'downScroll', true)
			setPropertyFromGroup('playerStrums', 3, 'downScroll', true)	
			noteTweenY("UpScrollBF1", 4, 565, 0.2, "linear")
			noteTweenY("UpScrollBF2", 5, 565, 0.2, "linear")
			noteTweenY("UpScrollBF3", 6, 565, 0.2, "linear")
			noteTweenY("UpScrollBF4", 7, 565, 0.2, "linear")
			end
		if curStep == 2671 then --m32
			noteTweenY("NOSATANOSY1", 0, 800, 0.05, "linear")
			noteTweenY("NOSATANOSY2", 1, 800, 0.05, "linear")
		...
		if curStep == 2736 then --m34
			setPropertyFromGroup('playerStrums', 1, 'downScroll', false)
			noteTweenY("DownScrollBF2", 5, 50, 0.3, "BackIn")
		end
		if curStep == 2744 then --m35
			noteTweenY("DownScrollBF4", 7, 50, 0.3, "BackIn")
			setPropertyFromGroup('playerStrums', 3, 'downScroll', false)	
		end
		if curStep == 2747 then --m36
			noteTweenY("DownScrollBF3", 6, 50, 0.3, "BackIn")
			setPropertyFromGroup('playerStrums', 2, 'downScroll', false)
		end
		if curStep == 2752 then --m37
			noteTweenY("DownScrollBF1", 4, 50, 0.3, "BackIn")
			setPropertyFromGroup('playerStrums', 0, 'downScroll', false)
		end
	end
end