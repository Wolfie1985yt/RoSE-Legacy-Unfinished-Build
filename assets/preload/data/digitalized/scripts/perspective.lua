...
----------- 3D SHIIIIIT LETS GOO --------------------

function onCreate()

    makeLuaSprite("xtersega", "bgs/xterion/xceilingsega", -3000, -4000)
    addLuaSprite("xtersega", false)
	scaleObject("xtersega", 10, 2, true)
	setPerspective("xtersega", 1)
	setVanishOffset(nil, -100)
end

function onUpdate(elapsed)
	if curStep == 630 then
		setPerspective("xtersega", 0)
	end
